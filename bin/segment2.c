...
// Hopefully these are safe...monkaS
__asm__(
 ".section \".data\"\n"
 ".balign 16\n"
 ".global small_font_default\n"
 "small_font_default:\n"
 ".incbin \"textures/segment2/custom_text.i4.bin\"\n"
 ".previous\n"
);
...
__asm__(
 ...
 "small_font_outline:\n"
 ".incbin \"textures/segment2/custom_text2.ia4.bin\"\n"
 ".previous\n"
);
...
__asm__(
 ...
 "small_font_plain:\n"
 ".incbin \"textures/segment2/custom_text3.i4.bin\"\n"
 ".previous\n"
);
...
__asm__(
 ...
 "small_font_vanilla:\n"
 ".incbin \"textures/segment2/custom_text4.i4.bin\"\n"
 ".previous\n"
);
...
__asm__(
 ".section \".data\"\n"
 ".balign 16\n"
 ".global small_font_bsm_custom\n"
 "small_font_bsm_custom:\n"
 ".incbin \"textures/segment2/custom_text5.ia4.bin\"\n"
 ".previous\n"
);
...
extern u8 small_font_bsm_custom[];
...
static const u8 small_font_kerning_bsm_custom[] = {
    /*!*/ 2, /*"*/ 5, /*#*/ 0, /*$*/ 0, /*%*/ 6, /*&*/ 7, /*'*/ 2, /*(*/ 4, /*)*/ 4, /***/ 0, /*+*/ 7, /*,*/ 2, /*-*/ 4, /*.*/ 2, /*/*/ 6, /*0*/ 6,
    /*1*/ 6, /*2*/ 6, /*3*/ 6, /*4*/ 6, /*5*/ 6, /*6*/ 6, /*7*/ 6, /*8*/ 6, /*9*/ 6, /*:*/ 2, /*;*/ 2, /*<*/ 0, /*=*/ 0, /*>*/ 0, /*?*/ 5, /*@*/ 0, 
    /*A*/ 7, /*B*/ 6, /*C*/ 6, /*D*/ 7, /*E*/ 6, /*F*/ 6, /*G*/ 7, /*H*/ 7, /*I*/ 4, /*J*/ 5, /*K*/ 6, /*L*/ 6, /*M*/ 7, /*N*/ 7, /*O*/ 7, /*P*/ 6, 
    /*Q*/ 7, /*R*/ 7, /*S*/ 6, /*T*/ 6, /*U*/ 7, /*V*/ 6, /*W*/ 7, /*X*/ 6, /*Y*/ 6, /*Z*/ 6, /*[*/ 0, /*\\*/ 0, /*]*/ 0, /*^*/ 6, /*_*/ 0, /*`*/ 0,  
    /*a*/ 6, /*b*/ 6, /*c*/ 5, /*d*/ 6, /*e*/ 6, /*f*/ 5, /*g*/ 6, /*h*/ 6, /*i*/ 2, /*j*/ 4, /*k*/ 6, /*l*/ 2, /*m*/ 6, /*n*/ 6, /*o*/ 6, /*p*/ 6, 
    /*q*/ 6, /*r*/ 5, /*s*/ 5, /*t*/ 5, /*u*/ 6, /*v*/ 6, /*w*/ 6, /*x*/ 6, /*y*/ 6, /*z*/ 5, /*{*/ 0, /*|*/ 0, /*}*/ 0, /*~*/ 7,
};
...
#include "textures/segment2/custom.colon.rgba16.inc.c"
};
...
ALIGNED8 static const Texture texture_hud_char_decimal_point[] = {
#include "textures/segment2/custom.decimal_point.rgba16.inc.c"
};
...
ALIGNED8 static const Texture texture_custom_bsm_hud_balloon_na[] = {
#include "textures/segment2/custom_bsm_hud_balloon_na.rgba16.inc.c"
};
...
ALIGNED8 static const Texture texture_custom_bsm_gold_mario[] = {
#include "textures/segment2/custom_bsm_hud_goldmario.rgba16.inc.c"
};

ALIGNED8 static const Texture texture_custom_bsm_wing_mario[] = {
#include "textures/segment2/custom_bsm_hud_wingcap.rgba16.inc.c"
};
...
const Texture *const main_hud_lut[] = {
    ...
    texture_custom_bsm_gold_mario, texture_custom_bsm_wing_mario, texture_custom_bsm_hud_balloon, texture_custom_bsm_hud_balloon_na,
