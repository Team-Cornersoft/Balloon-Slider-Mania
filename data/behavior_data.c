...
const BehaviorScript bhvKeyBalloon[] = {
    ...
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_key_balloon_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvPointBalloonPopped[] = {
    ...
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_point_balloon_popped_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvBSMMenuTitle[] = {
    ...
    SET_INT(oOpacity, 255),
    SET_HOME(),
    CALL_NATIVE(bhv_bsm_menu_title_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_bsm_menu_title_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvBSMRetryMenuRank[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INT(oOpacity, 255),
    CALL_NATIVE(bhv_bsm_retry_menu_rank_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_bsm_retry_menu_rank_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvCannonBarrel[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    DROP_TO_FLOOR(),
    CALL_NATIVE(bhv_cannon_barrel_init),
    BEGIN_LOOP(),
