...
extern const BehaviorScript bhvItemGate[];
extern const BehaviorScript bhvKeyGateOpen[];
extern const BehaviorScript bhvItemGateOpen[];
extern const BehaviorScript bhvSkiFlagSpawner[];
extern const BehaviorScript bhvPresent[];
...
extern const BehaviorScript bhvInvisibleDebugFloor[];
...
extern const BehaviorScript bhvBSMCelebrationWarp[];
