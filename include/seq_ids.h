...
enum SeqId {
    ...
    SEQ_CUSTOM_COURSE5_HOLIDAY,       // 0x28
    SEQ_CUSTOM_COURSE6_DRAGON,        // 0x29
    SEQ_CUSTOM_COURSE7_TWILIGHT,      // 0x2A
    SEQ_CUSTOM_COURSE8_CYBER,         // 0x2B
    SEQ_CUSTOM_COURSE9_CORNERSOFT,    // 0x2C
    SEQ_CUSTOM_SUCCESS_JINGLE,        // 0x2D
    SEQ_CUSTOM_TITLE_SCREEN,          // 0x2E
    SEQ_CUSTOM_ELISE_UNLOCK_JINGLE,   // 0x2F

    SEQ_COUNT
};

enum BetterReverbPresets {
    BRPRESET_DEFAULT_VANILLA,
    BRPRESET_DEFAULT_CONSOLE,
    BRPRESET_DEFAULT_EMULATOR,
    BRPRESET_BSM_LEVEL_SELECT,
    BRPRESET_BSM_C1_GENERAL,
    BRPRESET_BSM_C1_A2,
    BRPRESET_BSM_C2_GENERAL,
    BRPRESET_BSM_C4_GENERAL,
    BRPRESET_BSM_C4_A2,
    BRPRESET_BSM_C6_GENERAL,
    BRPRESET_BSM_C9_GENERAL,
    BRPRESET_BSM_ELISE_UNLOCK_JINGLE,

    BRPRESET_COUNT,

    BRPRESET_BSM_C3_GENERAL = BRPRESET_BSM_C1_GENERAL,
    BRPRESET_BSM_C3_A4 = BRPRESET_BSM_C1_A2,
};
