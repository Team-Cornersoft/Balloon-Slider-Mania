...
#define ACT_MUSHROOM_BOUNCE            0x0100088F // (0x082 | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
...
#define ACT_BSM_CELEBRATION            0x0000130B // (0x10B | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE)
