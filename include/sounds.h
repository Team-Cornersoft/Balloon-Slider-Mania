...
#define SOUND_NARRATION_BSM_READY           /* 0xFC2A0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x2A, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_GO              /* 0xFC2B0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x2B, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_TITLE           /* 0xFC2C0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x2C, 0x00, NARRATOR_SOUND_FLAGS)
