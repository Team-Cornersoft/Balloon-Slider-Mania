...
#define NARRATOR_SOUND_FLAGS (SOUND_DISCRETE | SOUND_NO_PRIORITY_LOSS | SOUND_CONSTANT_FREQUENCY)
...
#define SOUND_BANKS_FOREGROUND (\
    ...
    (1 << SOUND_BANK_EXTRA1) |\
    (1 << SOUND_BANK_EXTRA2) |\
    (1 << SOUND_BANK_SPECIAL1) |\
    (1 << SOUND_BANK_SPECIAL2) |\
    (1 << SOUND_BANK_CONT_ENV) |\
    (1 << SOUND_BANK_NARRATION))
...
// Channel A: EXTRA1
#define SOUND_EXTRA1_BSM_MENU_CHANGE_SELECTION   /* 0xA0002081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA1,   0x00, 0x20, SOUND_DISCRETE)
#define SOUND_EXTRA1_BSM_BALLOON_SMALLEST        /* 0xA0011081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA1,   0x01, 0x10, SOUND_DISCRETE | SOUND_VIBRATO)
#define SOUND_EXTRA1_BSM_BALLOON_SMALL           /* 0xA0021081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA1,   0x02, 0x10, SOUND_DISCRETE | SOUND_VIBRATO)
#define SOUND_EXTRA1_BSM_BALLOON_SEMISMALL       /* 0xA0031081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA1,   0x03, 0x10, SOUND_DISCRETE | SOUND_VIBRATO)
#define SOUND_EXTRA1_BSM_BALLOON_SEMILARGE       /* 0xA0041081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA1,   0x04, 0x10, SOUND_DISCRETE | SOUND_VIBRATO)
#define SOUND_EXTRA1_BSM_BALLOON_LARGE           /* 0xA0051081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA1,   0x05, 0x10, SOUND_DISCRETE | SOUND_VIBRATO)
#define SOUND_EXTRA1_BSM_BALLOON_LARGEST         /* 0xA0061081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA1,   0x06, 0x10, SOUND_DISCRETE | SOUND_VIBRATO)

// Channel B: EXTRA2
#define SOUND_EXTRA2_BSM_MENU_START_COURSE       /* 0xB400FF81 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x00, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_POINTS_5                /* 0xB0018081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x01, 0x80, SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_POINTS_10               /* 0xB0028081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x02, 0x80, SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_POINTS_25               /* 0xB0038081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x03, 0x80, SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_POINTS_50               /* 0xB0048081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x04, 0x80, SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_POINTS_100              /* 0xB0058081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x05, 0x80, SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_REDCOIN_0               /* 0xB0068081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x06, 0x80, SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_REDCOIN_1               /* 0xB0078081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x07, 0x80, SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_REDCOIN_2               /* 0xB0088081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x08, 0x80, SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_REDCOIN_3               /* 0xB0098081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x09, 0x80, SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_REDCOIN_4               /* 0xB00A8081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x0A, 0x80, SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_REDCOIN_5               /* 0xB00B8081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x0B, 0x80, SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_REDCOIN_6               /* 0xB00C8081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x0C, 0x80, SOUND_DISCRETE)
#define SOUND_EXTRA2_BSM_REDCOIN_7               /* 0xB00D8081 */ SOUND_ARG_LOAD(SOUND_BANK_EXTRA2,   0x0D, 0x80, SOUND_DISCRETE)

// Channel C: SPECIAL1
#define SOUND_SPECIAL1_BSM_BELL                  /* 0xC0002081 */ SOUND_ARG_LOAD(SOUND_BANK_SPECIAL1, 0x00, 0x20, SOUND_DISCRETE)
#define SOUND_SPECIAL1_BSM_GONG                  /* 0xC0012081 */ SOUND_ARG_LOAD(SOUND_BANK_SPECIAL1, 0x01, 0x20, SOUND_DISCRETE)
#define SOUND_SPECIAL1_BSM_BOUNCY_MUSHROOM       /* 0xC0022081 */ SOUND_ARG_LOAD(SOUND_BANK_SPECIAL1, 0x02, 0x20, SOUND_DISCRETE)
#define SOUND_SPECIAL1_BSM_CUSTOM_FADE_WARP      /* 0xC6032081 */ SOUND_ARG_LOAD(SOUND_BANK_SPECIAL1, 0x03, 0x20, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE | SOUND_VIBRATO)
#define SOUND_SPECIAL1_ELISE_WARP                /* 0xC2042081 */ SOUND_ARG_LOAD(SOUND_BANK_SPECIAL1, 0x04, 0x20, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)

// Channel D: SPECIAL2
#define SOUND_SPECIAL2_BOWSER_BALLOON            /* 0xD2002081 */ SOUND_ARG_LOAD(SOUND_BANK_SPECIAL2, 0x00, 0x20, SOUND_DISCRETE | SOUND_VIBRATO)
#define SOUND_SPECIAL2_CHEERING                  /* 0xD2010081 */ SOUND_ARG_LOAD(SOUND_BANK_SPECIAL2, 0x01, 0x00, 0)

// Channel E: ENV2
#define SOUND_CUSTOM_STEREO_RAIN                 /* 0xED004080 */ SOUND_ARG_LOAD(SOUND_BANK_CONT_ENV, 0x00, 0x40, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_CONSTANT_FREQUENCY)

// Channel F: NARRATION
#define SOUND_NARRATION_BSM_RANK_F_0        /* 0xFC000081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x00, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_F_1        /* 0xFC010081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x01, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_F_2        /* 0xFC020081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x02, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_D_0        /* 0xFC030081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x03, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_D_1        /* 0xFC040081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x04, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_D_2        /* 0xFC050081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x05, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_C_0        /* 0xFC060081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x06, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_C_1        /* 0xFC070081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x07, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_C_2        /* 0xFC080081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x08, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_B_0        /* 0xFC090081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x09, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_B_1        /* 0xFC0A0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x0A, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_B_2        /* 0xFC0B0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x0B, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_A_0        /* 0xFC0C0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x0C, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_A_1        /* 0xFC0D0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x0D, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_A_2        /* 0xFC0E0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x0E, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_S_0        /* 0xFC0F0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x0F, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_S_1        /* 0xFC100081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x10, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_S_2        /* 0xFC110081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x11, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_G_0        /* 0xFC120081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x12, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_G_1        /* 0xFC130081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x13, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_RANK_G_2        /* 0xFC140081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x14, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_VICTORY_0       /* 0xFC150081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x15, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_VICTORY_1       /* 0xFC160081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x16, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_VICTORY_2       /* 0xFC170081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x17, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_VICTORY_3       /* 0xFC180081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x18, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_FAIL_0          /* 0xFC190081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x19, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_FAIL_1          /* 0xFC1A0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x1A, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_FAIL_2          /* 0xFC1B0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x1B, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_FAIL_3          /* 0xFC1C0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x1C, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_ITEM_0          /* 0xFC1D0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x1D, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_ITEM_1          /* 0xFC1E0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x1E, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_ITEM_2          /* 0xFC1F0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x1F, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_ITEM_3          /* 0xFC200081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x20, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_ITEM_4          /* 0xFC210081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x21, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_REDS_0          /* 0xFC220081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x22, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_REDS_1          /* 0xFC230081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x23, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_REDS_2          /* 0xFC240081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x24, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_REDS_3          /* 0xFC250081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x25, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_TRACKSELECT_0   /* 0xFC260081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x26, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_TRACKSELECT_1   /* 0xFC270081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x27, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_TRACKSELECT_2   /* 0xFC280081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x28, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_TRACKSELECT_3   /* 0xFC290081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x29, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_TITLE           /* 0xFC2A0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x2A, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_READY_0         /* 0xFC2B0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x2B, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_READY_1         /* 0xFC2C0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x2C, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_READY_2         /* 0xFC2D0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x2D, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_GO_0            /* 0xFC2E0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x2E, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_GO_1            /* 0xFC2F0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x2F, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_GO_2            /* 0xFC300081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x30, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_PB_TIME_0       /* 0xFC310081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x31, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_PB_TIME_1       /* 0xFC320081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x32, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_PB_TIME_2       /* 0xFC330081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x33, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_PB_TIME_3       /* 0xFC340081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x34, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_BRONZE_MEDAL    /* 0xFC350081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x35, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_SILVER_MEDAL    /* 0xFC360081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x36, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_GOLD_MEDAL      /* 0xFC370081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x37, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_STAR_MEDAL      /* 0xFC380081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x38, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_DEV_TIME        /* 0xFC390081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x39, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_MANIA_MODE_0    /* 0xFC3A0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x3A, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_MANIA_MODE_1    /* 0xFC3B0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x3B, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_MANIA_MODE_2    /* 0xFC3C0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x3C, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_TIME_TRIALS_0   /* 0xFC3D0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x3D, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_TIME_TRIALS_1   /* 0xFC3E0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x3E, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_TIME_TRIALS_2   /* 0xFC3F0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x3F, 0x00, NARRATOR_SOUND_FLAGS)
