...
// Channel F: ENV2
#define SOUND_CUSTOM_STEREO_RAIN                 /* 0xDD004080 */ SOUND_ARG_LOAD(SOUND_BANK_CONT_ENV, 0x00, 0x40, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_CONSTANT_FREQUENCY)
