...
#define SOUND_NARRATION_BSM_DEV_TIME        /* 0xFC380081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x38, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_MANIA_MODE_0    /* 0xFC390081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x39, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_MANIA_MODE_1    /* 0xFC3A0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x3A, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_MANIA_MODE_2    /* 0xFC3B0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x3B, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_TIME_TRIALS_0   /* 0xFC3C0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x3C, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_TIME_TRIALS_1   /* 0xFC3D0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x3D, 0x00, NARRATOR_SOUND_FLAGS)
#define SOUND_NARRATION_BSM_TIME_TRIALS_2   /* 0xFC3E0081 */ SOUND_ARG_LOAD(SOUND_BANK_NARRATION, 0x3E, 0x00, NARRATOR_SOUND_FLAGS)
