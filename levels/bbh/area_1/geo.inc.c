...
const GeoLayout bbh_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -7975, 2413, 4566, bbh_dl_A_forest_a_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, bbh_dl_A_forest_a_mesh_layer_4),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -13755, 2770, -18682, bbh_dl_A_forest_b_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, bbh_dl_A_forest_b_mesh_layer_4),
		GEO_CLOSE_NODE(),
...
const GeoLayout bbh_dl_1_area1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, bbh_dl_A_area1_slide_a_mesh_layer_4),
		GEO_CLOSE_NODE(),
