...
const GeoLayout bob_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 0, -5905, 0, 0, 10, 0, bob_dl_0_SKY_DOME_mesh_layer_1),
		GEO_BILLBOARD_WITH_PARAMS_AND_DL(LAYER_TRANSPARENT, 30000, 31100, 16000, bob_dl_0_SKY_SUN_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_A_area1_slide_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
