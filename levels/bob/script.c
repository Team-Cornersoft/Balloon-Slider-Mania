...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		INSTANT_WARP(0x00, 0x02, -2384, 17816, -2253),
		MARIO_POS(0x01, -180, -16700, 8619, 14400),
		OBJECT(MODEL_NONE, -16700, 8619, 14400, 0, -180, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -16700, 8619, 14400, 0, -180, 0, 0x00F00000, bhvAirborneStarCollectWarp),
		OBJECT(MODEL_NONE, -16700, 8619, 14400, 0, -180, 0, 0x00F10000, bhvDeathWarp),
