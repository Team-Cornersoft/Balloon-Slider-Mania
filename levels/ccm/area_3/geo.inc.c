...
const GeoLayout ccm_dl_1_area3_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -10400, 1050, 1090, 0, -150, 0, ccm_dl_D_star_gate_a3_a_002_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout ccm_dl_2_area3_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 9143, -1934, 11477, ccm_dl_A_bowl_b_mesh_layer_1),
		GEO_OPEN_NODE(),
...
const GeoLayout ccm_dl_3_area3_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 4630, -5246, -10000, ccm_dl_A_bowl_c_mesh_layer_1),
		GEO_OPEN_NODE(),
