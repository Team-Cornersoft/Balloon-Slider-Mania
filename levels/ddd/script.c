...
const LevelScript level_ddd_entry[] = {
	...
	AREA(3, ddd_area_3),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, 35000, 0, -11000, 0, 0, 0, 0x00060000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 35000, 0, -11000, 0, 0, 0, 0x00060000, bhvPointBalloon),
		OBJECT(MODEL_NONE, 35126, 937, -7500, 0, 0, 0, 0x000B0000, bhvBSMCelebrationWarp),
	...
	AREA(4, ddd_area_4),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, 35000, 0, -9000, 0, 0, 0, 0x00050000, bhvPointBalloon),
		OBJECT(MODEL_BSM_TCS_TOKEN, 34988, 2382, -6778, 0, 0, 0, 0x00000000, bhvTCSToken),
	...
	AREA(6, ddd_area_6),
		...
		WARP_NODE(0xCC, LEVEL_SSL, 0x05, 0xCA, WARP_NO_CHECKPOINT),
		WARP_NODE(0xDB, LEVEL_SSL, 0x06, 0xDB, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BSM_POINT_BALLOON, -474000, 0, 24000, 0, 0, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 35000, 0, -18000, 0, 0, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 35000, 0, -18000, 0, 0, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 35000, 0, -18000, 0, 0, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 35000, 0, -18000, 0, 0, 0, 0x00010000, bhvPointBalloon),
