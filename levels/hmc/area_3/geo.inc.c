...
const GeoLayout hmc_dl_1_area3_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_TRANSPARENT, 5869, 1609, -6389, 45, -35, 0, hmc_dl_C_finish_line_mesh_layer_5),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_TRANSPARENT, -5819, 1609, -6389, 45, 35, 0, hmc_dl_C_finish_line_001_mesh_layer_5),
