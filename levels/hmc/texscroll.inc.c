...
void scroll_hmc_dl_C_finish_line_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 8;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(hmc_dl_C_finish_line_mesh_layer_5_vtx_0);
...
void scroll_hmc_dl_C_finish_line_001_mesh_layer_5_vtx_0() {
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(hmc_dl_C_finish_line_001_mesh_layer_5_vtx_0);
...
void scroll_hmc() {
	...
	scroll_hmc_dl_C_finish_line_mesh_layer_5_vtx_0();
	scroll_hmc_dl_C_finish_line_mesh_layer_5_vtx_1();
	scroll_hmc_dl_C_finish_line_mesh_layer_5_vtx_2();
	scroll_hmc_dl_C_finish_line_001_mesh_layer_5_vtx_0();
	scroll_hmc_dl_C_finish_line_001_mesh_layer_5_vtx_1();
	scroll_hmc_dl_C_finish_line_001_mesh_layer_5_vtx_2();
