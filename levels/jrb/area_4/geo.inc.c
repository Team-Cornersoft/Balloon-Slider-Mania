...
const GeoLayout jrb_dl_1_area4_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 2837, -5589, 3181, jrb_dl_A_environment_a4_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, jrb_dl_A_environment_a4_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 2837, -7239, 3181, jrb_dl_A_environment_a4_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 4133, -5032, 5001, jrb_dl_B_Caveshrooms_a_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -5135, -5260, 10404, jrb_dl_B_Caveshrooms_b_mesh_layer_1),
