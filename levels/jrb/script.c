...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_NONE, 10975, -4607, 9999, 0, 90, 0, 0x00C10000, bhvAirborneWarp),
		OBJECT(MODEL_NONE, -1628, -5516, 9831, 0, 0, 0, 0xA0C00000, bhvWarp),
		OBJECT(MODEL_NONE, -7141, -11254, -22598, 0, 0, 0, 0xA0C20000, bhvWarp),
	...
	AREA(2, jrb_area_2),
		...
		OBJECT(MODEL_NONE, 13783, -9008, 10045, 0, 130, 0, 0x00C00000, bhvAirborneWarp),
		OBJECT(MODEL_NONE, -14696, -9050, -3175, 0, -51, 0, 0x00C20000, bhvAirborneWarp),
		OBJECT(MODEL_NONE, 9164, -8993, 2839, 0, -1, 0, 0x00C40000, bhvAirborneWarp),
		OBJECT(MODEL_NONE, 14184, -10301, -13784, 0, 0, 0, 0xA0C00000, bhvWarp),
		OBJECT(MODEL_NONE, -13507, -10669, 13458, 0, 5, 0, 0xA0C10000, bhvWarp),
		OBJECT(MODEL_NONE, -4800, -10682, 983, 0, 20, 0, 0xA0C30000, bhvWarp),
		OBJECT(MODEL_NONE, -8209, -10119, -14068, 0, 0, 0, 0xA0C30000, bhvWarp),
		OBJECT(MODEL_NONE, 6780, -10293, -14401, 0, 0, 0, 0xA0C50000, bhvWarp),
	...
	AREA(3, jrb_area_3),
		...
		OBJECT(MODEL_NONE, -20726, 6338, -8443, 0, -90, 0, 0x00C00000, bhvAirborneWarp),
