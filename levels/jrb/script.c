...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_BSM_TCS_TOKEN, 17609, -5770, 7334, 0, -30, 0, 0x00000000, bhvTCSToken),
		...
		OBJECT(MODEL_NONE, -1628, -5516, 9831, 0, 0, 0, 0xA0C00000, bhvWarp),
		OBJECT(MODEL_NONE, -7176, -11259, -22639, 0, 0, 0, 0xA0C20000, bhvWarp),
		...
		SET_BACKGROUND_MUSIC_WITH_REVERB(0x00, SEQ_CUSTOM_COURSE2_WATERWAYS, BRPRESET_BSM_C3_GENERAL, BRPRESET_BSM_C3_GENERAL),
		SET_ECHO(0x02, 0x02),
	...
	AREA(2, jrb_area_2),
		...
		OBJECT(MODEL_NONE, 14199, -10311, -13897, 0, 0, 0, 0xA0C00000, bhvWarp),
		OBJECT(MODEL_NONE, -13583, -10676, 13467, 0, 5, 0, 0xA0C10000, bhvWarp),
		OBJECT(MODEL_NONE, -4820, -10688, 917, 0, 20, 0, 0xA0C30000, bhvWarp),
		OBJECT(MODEL_NONE, -8229, -10124, -14127, 0, 0, 0, 0xA0C30000, bhvWarp),
		OBJECT(MODEL_NONE, 6777, -10301, -14491, 0, 0, 0, 0xA0C50000, bhvWarp),
	...
	AREA(3, jrb_area_3),
		...
		OBJECT(MODEL_BSM_BOUNCY_SHROOM, -13768, 5285, -8537, 0, 0, 0, 0x40100000, bhvBouncyShroom),
		OBJECT(MODEL_BSM_BOUNCY_SHROOM, -7368, 2285, -11137, 0, 0, 0, 0x40100000, bhvBouncyShroom),
		OBJECT(MODEL_BSM_BOUNCY_SHROOM, -7368, 2285, -9137, 0, 0, 0, 0x40100000, bhvBouncyShroom),
		OBJECT(MODEL_BSM_BOUNCY_SHROOM, -968, -1115, -10137, 0, 0, 0, 0x40100000, bhvBouncyShroom),
		OBJECT(MODEL_BSM_BOUNCY_SHROOM, 4432, -4315, -7937, 0, 0, 0, 0x20180000, bhvBouncyShroom),
	...
	AREA(4, jrb_area_4),
		...
		TERRAIN_TYPE(TERRAIN_SLIDE),
		/* Fast64 begin persistent block [area commands] */
		SET_BACKGROUND_MUSIC_WITH_REVERB(0x00, SEQ_CUSTOM_COURSE2_WATERWAYS, BRPRESET_BSM_C3_A4, BRPRESET_BSM_C3_A4),
		SET_ECHO(0x20, 0x20),
		/* Fast64 end persistent block [area commands] */
	END_AREA(),
