...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_NONE, 10991, -4609, 10000, 0, 90, 0, 0x00C10000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -1526, -8192, 9797, 0, 0, 0, 0xA0C00000, bhvWarp),
	...
	AREA(2, jrb_area_2),
		...
		OBJECT(MODEL_NONE, 13783, -9008, 10045, 0, -50, 0, 0x00C00000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -14696, -9050, -3175, 0, 129, 0, 0x00C20000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 9164, -8993, 2839, 0, -178, 0, 0x00C40000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 14167, -10386, -14752, 0, 0, 0, 0xA0C00000, bhvWarp),
		OBJECT(MODEL_NONE, -14239, -10733, 13511, 0, 0, 0, 0xA0C10000, bhvWarp),
		OBJECT(MODEL_NONE, -5003, -10741, 334, 0, 0, 0, 0xA0C20000, bhvWarp),
		OBJECT(MODEL_NONE, -8358, -10190, -14871, 0, 0, 0, 0xA0C20000, bhvWarp),
	...
	AREA(3, jrb_area_3),
		...
		OBJECT(MODEL_NONE, -20726, -62, -8443, 0, 90, 0, 0x00C00000, bhvSpinAirborneWarp),
		OBJECT(MODEL_BSM_BOUNCY_SHROOM, -13768, -915, -8537, 0, 0, 0, 0x00100000, bhvBouncyShroom),
		OBJECT(MODEL_BSM_BOUNCY_SHROOM, -10568, -915, -10137, 0, 0, 0, 0x00100000, bhvBouncyShroom),
		OBJECT(MODEL_BSM_BOUNCY_SHROOM, -10568, -915, -6937, 0, 0, 0, 0x00100000, bhvBouncyShroom),
