...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_ELISE,                    elise_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BSM_ITEM_GATE,            item_gate_geo),
    FREE_LEVEL_POOL(),
    POP_POOL(),
...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BSM_CANNON_BARREL,       custom_cannon_geo),
    RETURN(),
};
