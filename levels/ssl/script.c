...
const LevelScript level_ssl_entry[] = {
	...
	AREA(3, ssl_area_3),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, 8082, -1503, -5587, 0, 70, 0, 0x00050000, bhvPointBalloon),
		OBJECT(MODEL_BSM_TCS_TOKEN, 8900, 3610, 23355, 0, -45, 0, 0x00000000, bhvTCSToken),
		OBJECT(MODEL_NONE, -14000, 10232, -24876, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -11173, 3300, 26974, 0, -96, 0, 0x00CD0000, bhvInstantActiveWarp),
