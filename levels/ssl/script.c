...
const LevelScript level_ssl_entry[] = {
	...
	AREA(2, ssl_area_2),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, 8500, 238, -7545, 0, 0, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 8000, 885, 2444, 0, 0, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 11500, 238, -7545, 0, 0, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 12000, 885, 2444, 0, 0, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -10000, -598, -14009, 0, 0, 0, 0x00020000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 11000, 1209, 7439, 0, 0, 0, 0x00000000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 13000, 562, -2550, 0, 0, 0, 0x00000000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 7000, 562, -2550, 0, 0, 0, 0x00000000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -9000, -95, -1787, 0, 0, 0, 0x00000000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -11000, 777, 8175, 0, 0, 0, 0x00000000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 9000, 1209, 7439, 0, 0, 0, 0x00000000, bhvPointBalloon),
		...
		OBJECT(MODEL_NONE, -10000, -1400, -18300, 0, 0, 0, 0x40CB00C3, bhvWarp),
		OBJECT(MODEL_NONE, 10000, -800, -19300, 0, 0, 0, 0x40DB00C3, bhvWarp),
	...
	AREA(4, ssl_area_4),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, 18000, 22, -2576, 0, 0, 0, 0x00020000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 22000, 22, -2576, 0, 0, 0, 0x00020000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -23000, 702, -2857, 0, 0, 0, 0x00020000, bhvPointBalloon),
		...
		OBJECT(MODEL_NONE, -22000, -600, -19300, 0, 0, 0, 0x40CB00C3, bhvWarp),
		OBJECT(MODEL_NONE, -18000, -3400, -19000, 0, 0, 0, 0x40CC00C3, bhvWarp),
		OBJECT(MODEL_NONE, 0, -1200, -19400, 0, 0, 0, 0x40DB00C3, bhvWarp),
		OBJECT(MODEL_NONE, 20000, -3200, -18100, 0, 0, 0, 0x40EB00C3, bhvWarp),
	...
	AREA(5, ssl_area_5),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, 18300, 1085, 2427, 0, 0, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 21700, 1085, 2427, 0, 0, 0, 0x00010000, bhvPointBalloon),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, -21000, 1275, 7131, 0, 0, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -20000, 1038, 2133, 0, 0, 0, 0x00010000, bhvPointBalloon),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, -22000, -598, -15009, 0, 0, 0, 0x00030000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 17500, 860, -2576, 0, 0, 0, 0x00000000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 22500, 860, -2576, 0, 0, 0, 0x00000000, bhvPointBalloon),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, -18000, 565, -7879, 0, 0, 0, 0x00000000, bhvPointBalloon),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, -1200, 266, -4848, 0, 0, 0, 0x00060000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 0, -13, -8036, 0, 0, 0, 0x00060000, bhvPointBalloon),
		OBJECT(MODEL_BSM_KEY_GATE, -20319, -997, -13618, 0, 90, 0, 0x00000000, bhvKeyGate),
		OBJECT(MODEL_BSM_KEY_GATE, -23119, -997, -9794, 0, 0, 0, 0x00000000, bhvKeyGate),
		OBJECT(MODEL_BSM_KEY_GATE, -21019, -997, -11006, 0, 60, 0, 0x00000000, bhvKeyGate),
		OBJECT(MODEL_BSM_KEY_GATE, -20319, -997, -16418, 0, 90, 0, 0x00000000, bhvKeyGate),
		OBJECT(MODEL_BSM_KEY_GATE, -20319, -997, -19218, 0, 90, 0, 0x00000000, bhvKeyGate),
		OBJECT(MODEL_BSM_KEY_GATE, -20319, 903, -13618, 0, 90, 0, 0x00000000, bhvKeyGate),
		OBJECT(MODEL_BSM_KEY_GATE, -23119, 903, -9794, 0, 0, 0, 0x00000000, bhvKeyGate),
		OBJECT(MODEL_BSM_KEY_GATE, -21019, 903, -11006, 0, 60, 0, 0x00000000, bhvKeyGate),
		OBJECT(MODEL_BSM_KEY_GATE, -20319, 903, -16418, 0, 90, 0, 0x00000000, bhvKeyGate),
		OBJECT(MODEL_BSM_KEY_GATE, -20319, 903, -19218, 0, 90, 0, 0x00000000, bhvKeyGate),
		...
		OBJECT(MODEL_NONE, -22000, -1400, -19300, 0, 0, 0, 0x40CB00C3, bhvWarp),
		OBJECT(MODEL_NONE, -18000, -1400, -19300, 0, 0, 0, 0x40CC00C3, bhvWarp),
		OBJECT(MODEL_NONE, 0, -1100, -19300, 0, 0, 0, 0x40DB00C3, bhvWarp),
		OBJECT(MODEL_NONE, 20000, -600, -19300, 0, 0, 0, 0x40EB00C3, bhvWarp),
