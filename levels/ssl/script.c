...
const LevelScript level_ssl_entry[] = {
	...
	AREA(1, ssl_area_1),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, -81520, 3181, 3104, 0, -165, 0, 0x00020000, bhvPointBalloon),
	...
	AREA(2, ssl_area_2),
		...
		OBJECT(MODEL_NONE, -10000, 0, -18300, 0, 0, 0, 0x80CB003C, bhvWarp),
		OBJECT(MODEL_NONE, 10000, 400, -18300, 0, 0, 0, 0x80DB003C, bhvWarp),
	...
	AREA(4, ssl_area_4),
		...
		OBJECT(MODEL_NONE, 22002, 1745, 16584, 0, -180, 0, 0x00EA0000, bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, -22000, 400, -17300, 0, 0, 0, 0x80CB003C, bhvWarp),
		OBJECT(MODEL_NONE, -18000, -2800, -17000, 0, 0, 0, 0x80CC003C, bhvWarp),
		OBJECT(MODEL_NONE, 0, -200, -18100, 0, 0, 0, 0x80DB003C, bhvWarp),
		OBJECT(MODEL_NONE, 22000, -2600, -17100, 0, 0, 0, 0x80EB003C, bhvWarp),
	...
	AREA(5, ssl_area_5),
		...
		OBJECT(MODEL_NONE, 22007, 1920, 16856, 0, -180, 0, 0x00EA0000, bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, -22000, -800, -17300, 0, 0, 0, 0x80CB003C, bhvWarp),
		OBJECT(MODEL_NONE, -18000, -800, -17300, 0, 0, 0, 0x80CC003C, bhvWarp),
		OBJECT(MODEL_NONE, 0, -400, -18300, 0, 0, 0, 0x80DB003C, bhvWarp),
		OBJECT(MODEL_NONE, 22000, 400, -18300, 0, 0, 0, 0x80EB003C, bhvWarp),
	...
	AREA(6, ssl_area_6),
		...
		WARP_NODE(0xCC, LEVEL_SSL, 0x05, 0xCA, WARP_NO_CHECKPOINT),
		WARP_NODE(0xDB, LEVEL_SSL, 0x06, 0xDB, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BSM_POINT_BALLOON, -262, 4028, 1027, 0, -155, 0, 0x00040000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 744, 5675, -7120, 0, -155, 0, 0x00040000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 3810, 5281, -5386, 0, 65, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 2837, 4681, -1781, 0, -80, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 4506, 3331, 2138, 0, -115, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -4426, 4381, -5806, 0, 15, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -9059, 4981, -8409, 0, -47, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -5465, 6781, -14285, 0, -58, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 4625, 2881, 5355, 0, -55, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 1291, 6781, -14510, 0, 60, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -9568, 2881, 4808, 0, 75, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -5695, 6031, -8313, 0, 20, 0, 0x00010000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 1291, 6031, -9935, 0, -45, 0, 0x00010000, bhvPointBalloon),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, 2708, 6391, -12137, 0, 0, 0, 0x00020000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 5417, 3081, 3740, 0, 0, 0, 0x00020000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -6977, 6420, -11650, 0, -5, 0, 0x00020000, bhvPointBalloon),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, -6582, 2581, 4501, 0, 95, 0, 0x00000000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 2269, 3631, 2276, 0, -85, 0, 0x00000000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -6935, 5581, -4776, 0, 110, 0, 0x00000000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -1500, 7415, -18200, 0, 5, 0, 0x00000000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 2153, 2581, 5461, 0, -90, 0, 0x00000000, bhvPointBalloon),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, -9556, 5281, -5825, 0, 25, 0, 0x00000000, bhvPointBalloon),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, 540, 4381, -1478, 0, 120, 0, 0x00000000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -1500, 7915, -22200, 0, 0, 0, 0x00000000, bhvPointBalloon),
		OBJECT(MODEL_BSM_KEY_GATE, -2219, 7303, -14694, 0, -90, 0, 0x00000000, bhvKeyGate),
		OBJECT(MODEL_BSM_KEY_GATE, 581, 7303, -18518, 0, 180, 0, 0x00000000, bhvKeyGate),
		OBJECT(MODEL_BSM_KEY_GATE, -1519, 7303, -17306, 0, -120, 0, 0x00000000, bhvKeyGate),
		...
		OBJECT(MODEL_BSM_POINT_BALLOON, -6302, 4681, -8601, 0, 60, 0, 0x00050000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, 4799, 4981, -3152, 0, -15, 0, 0x00050000, bhvPointBalloon),
		OBJECT(MODEL_BSM_POINT_BALLOON, -2001, 7665, -20200, 0, 0, 0, 0x00050000, bhvPointBalloon),
