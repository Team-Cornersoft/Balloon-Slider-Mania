...
const GeoLayout wf_dl_1_area1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -10000, 503, 16791, wf_dl_A_Aqueduct_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -10000, 168, 7197, wf_dl_A_Aqueduct_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -10000, -168, -2397, wf_dl_A_Aqueduct_002_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -10000, -503, -11991, wf_dl_A_Aqueduct_003_mesh_layer_1),
