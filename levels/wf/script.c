...
const LevelScript level_wf_entry[] = {
    ...
    AREA(/*index*/ 1, wf_geo_000BF8),
        OBJECT(/*model*/ MODEL_BSM_POINT_BALLOON, /*pos*/ -1000, 6000, 0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvNone),
        OBJECT(/*model*/ MODEL_BSM_POINT_BALLOON, /*pos*/  -500, 6000, 0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00010000, /*beh*/ bhvNone),
        OBJECT(/*model*/ MODEL_BSM_POINT_BALLOON, /*pos*/     0, 6000, 0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00020000, /*beh*/ bhvNone),
        OBJECT(/*model*/ MODEL_BSM_POINT_BALLOON, /*pos*/   500, 6000, 0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00030000, /*beh*/ bhvNone),
        OBJECT(/*model*/ MODEL_BSM_POINT_BALLOON, /*pos*/  1000, 6000, 0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00040000, /*beh*/ bhvNone),
