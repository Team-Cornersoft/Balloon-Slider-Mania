...
static const u16 BSMGRanks[BSM_COURSE_COUNT] = {
    [BSM_COURSE_1_SNOWY_PEAK]        = 2770,
    [BSM_COURSE_2_LAVA_ISLE]         = 1840,
    [BSM_COURSE_3_FUNGI_CANYON]      = 2155,
    [BSM_COURSE_4_STARLIGHT_FEST]    = 2065,
    [BSM_COURSE_5_HOLIDAY_PEAK]      = 2115,
    [BSM_COURSE_6_SCORCH_ISLE]       = 1900,
    [BSM_COURSE_7_SPORE_CANYON]      = 1975,
    [BSM_COURSE_8_CYBER_FEST]        = 1700,
